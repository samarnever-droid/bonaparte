...
- Compositions: up to 16,384 px per axis, **67,108,864 pixels**, exact-tick frame rates between 1 and 1000 fps, duration up to 24 h. These are validation ceilings, not performance guarantees.
...
- History: 1000 transactions; at most 65,536 operations in a non-nested Batch. Effect stacks: at most 64 instances per layer. History is session-local, not stored in project files.
